                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn-group btn-group-sm flex-wrap">
                            <button type="button" class="btn btn-outline-primary quick-amount" data-amount="<?= $loan->emi_amount ?>">
                                1 EMI (₹<?= number_format($loan->emi_amount) ?>)
                            </button>
                            <button type="button" class="btn btn-outline-primary quick-amount" data-amount="<?= $loan->emi_amount * 2 ?>">
                                2 EMIs (₹<?= number_format($loan->emi_amount * 2) ?>)
                            </button>
                            <button type="button" class="btn btn-outline-primary quick-amount" data-amount="<?= $loan->emi_amount * 3 ?>">
                                3 EMIs (₹<?= number_format($loan->emi_amount * 3) ?>)
                            </button>
                            <?php if ($overdue_emis): ?>
                            <button type="button" class="btn btn-outline-danger quick-amount" 
                                    data-amount="<?= array_sum(array_column($overdue_emis, 'emi_amount')) ?>">
                            ...
                            <button type="button" class="btn btn-outline-success quick-amount" 
                                    data-amount="<?= $loan->outstanding_principal + $loan->outstanding_interest ?>">
