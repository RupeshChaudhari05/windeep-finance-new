<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open('admin/bank/accounts/create'); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="account_name" name="account_name"
                                   value="<?php echo set_value('account_name'); ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bank_name" name="bank_name"
                                   value="<?php echo set_value('bank_name'); ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="account_number" name="account_number"
                                   value="<?php echo set_value('account_number'); ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="account_type" name="account_type" required>
                                ...
                                <option value="current" <?php echo set_select('account_type', 'current'); ?>>Current Account</option>
                                <option value="savings" <?php echo set_select('account_type', 'savings'); ?>>Savings Account</option>
                                <option value="cash" <?php echo set_select('account_type', 'cash'); ?>>Cash Account</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="opening_balance" name="opening_balance"
                                   value="<?php echo set_value('opening_balance', '0.00'); ?>" step="0.01">
