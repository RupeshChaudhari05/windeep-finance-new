...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-history mr-1"></i> Audit Trail Report</h3>
        <div class="card-tools">
            <form class="form-inline" method="get" action="">
                ...
                <a href="<?= site_url('admin/reports/audit_log') ?>" class="btn btn-secondary btn-sm ml-1"><i class="fas fa-times"></i></a>
            </form>
        </div>
    </div>
