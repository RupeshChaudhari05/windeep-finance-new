...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .alert-info { background: #e7f5ff; color: #1864ab; }
        .help-tip {
            background: #f8f9fa; border-radius: 10px; padding: 12px 16px;
            margin-top: 16px; font-size: 0.82rem; color: #495057;
        }
        .help-tip i { color: #667eea; }
...
<div class="login-wrapper">
    ...
    <div class="login-card">
        <div class="login-tabs">
            <a href="<?= site_url('admin/login') ?>"><i class="fas fa-user-shield mr-1"></i>Admin</a>
            <a href="#" class="active"><i class="fas fa-user mr-1"></i>Member</a>
        </div>
        
        <div class="login-body">
            <h2>Member Login</h2>
            <p class="subtitle">Access your account with your member code</p>
            ...
            <form action="<?= site_url('member/auth/login') ?>" method="post" id="loginForm">
                ...
                <div class="form-group">
                    <label for="identifier">Member Code</label>
                    <div class="input-icon-wrap">
                        <i class="fas fa-id-card input-icon"></i>
                        <input type="text" id="identifier" name="identifier" class="form-control" placeholder="e.g. MEM-0001" required autofocus autocomplete="username">
                    </div>
                </div>
            ...
            <div class="help-tip">
                <i class="fas fa-info-circle mr-1"></i>
                <strong>First time?</strong> Use your Member Code as password, then change it after login.
            </div>
        </div>
